...
IMG ?= dns-resolution-operator:v${VERSION}
...
helm: manifests kustomize helmify yq
	rm -r helm/chart
	$(KUSTOMIZE) build config/default | $(HELMIFY) -crd-dir helm/chart
	cd helm && ./patches.sh
